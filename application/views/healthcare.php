    ...
    <title>No.1 Hospital Website Design Company With Best Packages | BMDU</title>
    <!--meta-->
    <meta name="description" content="We are well known hospital design company focuses on mobile friendly & web responsive designs for easily accessible to users.">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-12">
                <h1 class="display-5 fw-bold">Healthcare/ Hospital Website Design Company</h1>
                <p class="lead">BMDU is a prominent Hospital Website Design company.</p>
            </div>
        </div>
...
<section class="feature-section pt-60 pb-120" style="background: url(<?php echo base_url('assets/img/page-header-bg.svg'); ?>)no-repeat bottom right">
    <div class="container">
        <div class="row align-items-lg-center justify-content-between">
            <div class="col-lg-6 order-lg-1 mb-7 mb-lg-0">
                <div class="mb-4">
                    <h2>Advanced analytics easy to understand for sales</h2>
                    <p>BMDU specialises in healthcare websites & known as best medical website design
                        company. We do the intelligent examination of data and content using the right
                        techniques and tools to discover better and deeper insights, make predictions, or
                        generate recommendations. We also do web design for financial services, hospitality,
                        biotech, retail etc.</p>
                </div>
            ...
            <div class="col-lg-6 order-lg-2">
                <div class="pr-lg-4 position-relative">
                    <div class="bg-light text-center rounded-custom overflow-hidden p-lg-5 p-4 mx-lg-auto">
                        <img src="<?php echo base_url('assets/img/dashboard-img-4.png'); ?>" alt="Hospital Website Design Company," class="img-fluid rounded-custom shadow-sm">
                ...
                <div class="hero-img-wrap position-relative aos-init aos-animate" data-aos="fade-left">
                    ...
                    <ul class="position-absolute animate-element parallax-element shape-service hide-medium" style="transform: translate3d(0px, 0px, 0px); transform-style: preserve-3d; backface-visibility: hidden;">
                        <li class="layer" data-depth="0.03" style="position: relative; display: block; left: 0px; top: 0px; transform: translate3d(14.3175px, -7.39215px, 0px); transform-style: preserve-3d; backface-visibility: hidden;">
                            <img src="<?php echo base_url('assets/img/color-shape/image-1.svg'); ?>" alt="Hospital Website Design Company," class="img-fluid position-absolute color-shape-1">
                        </li>
                        <li class="layer" data-depth="0.02" style="position: absolute; display: block; left: 0px; top: 0px; transform: translate3d(9.54501px, -4.9281px, 0px); transform-style: preserve-3d; backface-visibility: hidden;">
                            <img src="<?php echo base_url('assets/img/color-shape/feature-2.svg'); ?>" alt="Hospital Website Design Company," class="img-fluid position-absolute color-shape-2 z-5">
                        </li>
                        <li class="layer" data-depth="0.03" style="position: absolute; display: block; left: 0px; top: 0px; transform: translate3d(14.3175px, -7.39215px, 0px); transform-style: preserve-3d; backface-visibility: hidden;">
                            <img src="<?php echo base_url('assets/img/color-shape/feature-3.svg'); ?>" alt="Hospital Website Design Company," class="img-fluid position-absolute color-shape-3">
                        </li>
                    </ul>
                    <!--animated shape end-->
                    <div class="hero-img-wrap position-relative">
                        <div class="hero-screen-wrap">
                            <div class="phone-screen">
                                <img src="<?php echo base_url('assets/img/screen/phone-screen.png'); ?>" alt="Healthcare Website Design" class="position-relative img-fluid">
                            </div>
                            <div class="mac-screen">
                                <img src="<?php echo base_url('assets/img/screen/mac-screen.png'); ?>" alt="Healthcare Website Design" class="position-relative img-fluid rounded-custom">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-10 col-lg-6">
                <div class="section-heading text-center aos-init aos-animate" data-aos="fade-up">
                    ...
                    <p>We find powerful and relevant ideas to help achieve the objectives and goals of the company. </p>
                </div>
            </div>
        </div>
        <div class="row d-flex align-items-center">
            <div class="col-md-6 col-lg-3">
                <div class="process-card text-center px-4 py-lg-5 py-4 rounded-custom shadow-hover mb-3 mb-lg-0 aos-init aos-animate" data-aos="fade-up" data-aos-delay="50">
                    ...
                    <p class="mb-0">We gather information on all areas of the business to leverage this data for organizational growth, increase sales etc.</p>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3">
                <div class="process-card text-center px-4 py-lg-5 py-4 rounded-custom shadow-hover mb-3 mb-lg-0 aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <p class="mb-0">Have the best team of designers to design the design part.</p>
                </div>
            </div>
            <div class="dots-line first"></div>
            <div class="col-md-6 col-lg-3">
                <div class="process-card text-center px-4 py-lg-5 py-4 rounded-custom shadow-hover mb-3 mb-lg-0 mb-md-0 aos-init aos-animate" data-aos="fade-up" data-aos-delay="150">
                    ...
                    <p class="mb-0">Building the project step by step.</p>
                </div>
            </div>
            <div class="dots-line first"></div>
            <div class="col-md-6 col-lg-3">
                <div class="process-card text-center px-4 py-lg-5 py-4 rounded-custom shadow-hover mb-0 aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <p class="mb-0">We aim to deliver you results greater than your expectations.</p>
                </div>
            </div>
        </div>
    </div>
