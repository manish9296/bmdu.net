...
if($_POST['website_type']=="Corporate"){
    ...
    if($_POST['page_type']==25){
        ...
        $response = ["page_type"=>"50","pagePrice"=>30000,"websitePrice"=>40000,"pageTitle"=>"Unlimited","totalPrice"=>70000,"id"=>"page_unlimited"];
        echo json_encode($response);
    }
    ...
    if($_POST['page_type']==25){
        ...
        // $response = ["website_type"=>"Corporate","page"=>25,"pageId"=>"page_20_to_25","websitePrice"=>40000,"totalPrice"=>50000,"id"=>"corporate"];
        $response = ["page_type"=>"25","pagePrice"=>25000,"websitePrice"=>30000,"pageTitle"=>"21-25","totalPrice"=>55000,"id"=>"page_20_to_25"];
        echo json_encode($response);
    


    }elseif($_POST['page_type']==20){
        $response = ["page_type"=>"20","pagePrice"=>24000,"websitePrice"=>25000,"pageTitle"=>"9-20","totalPrice"=>49000,"id"=>"page_9_to_20"];
        echo json_encode($response);
        


    }elseif($_POST['page_type']==8){
        $response = ["page_type"=>"8","pagePrice"=>0,"websitePrice"=>25000,"pageTitle"=>"5-8","totalPrice"=>25000,"id"=>"page_5_to_8"];
        echo json_encode($response);
        
        
    }elseif($_POST['page_type']==4){
        $response = ["page_type"=>"4","pagePrice"=>0,"websitePrice"=>25000,"pageTitle"=>"1-4","totalPrice"=>25000,"id"=>"page_1_to_4"];
        echo json_encode($response);
    ...
    if($_POST['page_type']==25){
        ...
        // $response = ["website_type"=>"Corporate","page"=>25,"pageId"=>"page_20_to_25","websitePrice"=>40000,"totalPrice"=>50000,"id"=>"corporate"];
        $response = ["page_type"=>"25","pagePrice"=>21000,"websitePrice"=>31000,"pageTitle"=>"21-25","totalPrice"=>31000,"id"=>"page_20_to_25"];
        echo json_encode($response);
    


    }elseif($_POST['page_type']==20){
        $response = ["page_type"=>"20","pagePrice"=>16000,"websitePrice"=>26000,"pageTitle"=>"9-20","totalPrice"=>26000,"id"=>"page_9_to_20"];
        echo json_encode($response);
        


    }elseif($_POST['page_type']==8){
        $response = ["page_type"=>"8","pagePrice"=>4000,"websitePrice"=>14000,"pageTitle"=>"5-8","totalPrice"=>14000,"id"=>"page_5_to_8"];
        echo json_encode($response);
        
        
    }elseif($_POST['page_type']==4){
        $response = ["page_type"=>"4","pagePrice"=>0,"websitePrice"=>10000,"pageTitle"=>"1-4","totalPrice"=>10000,"id"=>"page_1_to_4"];
        echo json_encode($response);

        
    }elseif($_POST['page_type']==50){
        $response = ["page_type"=>"50","pagePrice"=>46000,"websitePrice"=>56000,"pageTitle"=>"Unlimited","totalPrice"=>56000,"id"=>"page_unlimited"];
        echo json_encode($response);
