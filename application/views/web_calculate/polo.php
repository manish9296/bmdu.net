...
<script>
    function printData() {
        const paymentDetails = document.getElementById('your_order').innerText;
        const individualItems = paymentDetails.split('\n');
        individualItems.forEach((item, index) => {
            sessionStorage.setItem(`orderDetails${index}`, item.trim());
        });
    }
</script>
...
<body>
    <div class="collapse show" id="collapseExample ">
        <div class="card card-body">
                    ...
                    <div class="row">
                                ...
                                <div class="multisteps_form_panel">
                                            ...
                                            <div class="">
                                                <ul class="text-center website_type_class">
                                                    <li class="position-relative step_1 d-inline-block">
                                                        <input id="static" type="radio" name="website_type" value="Static / Information">
                                                    ...
                                                    <li class="step_1 position-relative d-inline-block ">
                                                        <input id="corporate" type="radio" name="website_type" value="Corporate">
                                                    ...
                                                    <li class="step_1 position-relative d-inline-block ">
                                                        <input id="e_commerce" type="radio" name="website_type" value="E Commerce">
                                    ...
                                    <div class="row pt-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="co_form">
                                                <input type="text" name="hosting_space" readonly class="red" placeholder="Space As Per Need">
                                            </div>
                                        </div>
                                            ...
                                            <div class="">
                                                <ul class="multiple_check" id="multiple_check">
                                                    ...
                                                    <li> <input id="" type="checkbox" name="pages_name[]" value="Product">
                                                        Product </li>
                                                    <li> <input id="" type="checkbox" name="pages_name[]" value="Product Detail"> Product Detail </li>
                                                    ...
                                                    <li> <input id="" type="checkbox" name="pages_name[]" value="Terms & Conditions"> Terms & Conditions </li>
                                                    <li> <input id="" type="checkbox" name="pages_name[]" value="Privacy Policy"> Privacy Policy </li>
                                                    <li> <input id="" type="checkbox" name="pages_name[]" value="Refund Policy">
                                                        Refund Policy </li>
                                                    <li> <input id="" type="checkbox" name="pages_name[]" value="Cancellation Policy"> Cancellation Policy </li>
                                        ...
                                        <div class="col-md-12">
                                            <div class="respn">
                                                ...
                                                <div class="co_form">
                                                    ...
                                                    <input type="checkbox" class="checke" name="responsive" id="compulsory" Value="1" checked>
                                        ...
                                        <div class="col-md-12">
                                            <div class="">
                                                <ul class="multiple_check Seo Sevv">
                                                    <li for="seo"> <input id="seo" type="checkbox" class="spereq" name="specialRequirment" price="5000" value="Seo Friendly"> Seo
                                                        Friendly </li>
                                                    <li> <input id="onPage" type="checkbox" class="spereq" name="specialRequirment" value="On Page Seo" price="2000"> On Page
                                                        Seo </li>

                                                    <li> <input id="socialMedia" type="checkbox" class="spereq" name="specialRequirment" price="500" value="Social Media Linking">
                                                    ...
                                                    <li> <input id="popup" type="checkbox" class="spereq" name="specialRequirment" price="500" value="Popup Enquiry"> Popup
                                                        Enquiry </li>
                                                    <li> <input id="bannerDynamic" type="checkbox" class="spereq" name="specialRequirment" value="Banner Dynamic"> Banner Dynamic
                                                    </li>
                                                    <li> <input id="adminPanel" type="checkbox" class="spereq" name="specialRequirment" value="Admin Pannel"> Admin Pannel <span class="ques_mark"> ? </span>
                                                        <div class="Img_ho">
                                                            <div class="tt">
                                                    ...
                                                    <li> <input id="editPage" type="checkbox" class="spereq" name="specialRequirment" value="Edit Pages"> Edit Pages </li>
                                                    <li> <input id="managePage" type="checkbox" class="spereq" name="specialRequirment" value="Manage Pages"> Manage Pages </li>
                                                    <li> <input id="contentWriting" type="checkbox" class="spereq" name="specialRequirment" price="500" value="Content Writing">
                                                        Content Writing </li>
                                                </ul>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="">
                                                <ul class="multiple_check Seo tiw_c Sevv">
                                                    <li> <input id="tawkLiveChat" type="checkbox" price="500" value="Tawk Live Chat"> Tawk Live Chat
                                                    ...
                                                    <li> <input id="googleMyBusiness" type="checkbox" price="500" value="Google My Bussiness Page"> Google My Bussiness Page
                                                        <span class="ques_mark"> ? </span>
                                                        <div class="Img_ho">
                                                            <div class="tt">
                                                    ...
                                                    <li> <input id="whatsappChat" type="checkbox" price="500" value="Whatsapp Chat"> Whatsapp Chat
                                                        <span class="ques_mark"> ? </span>
                                                        <div class="Img_ho">
                                                            <div class="tt">
                                                    ...
                                                    <li> <input id="paymentGateway" type="checkbox" price="5000" value="Payment Gateway"> Payment Gateway
                                                        <span class="ques_mark"> ? </span>
                                                        <div class="Img_ho">
                                                            <div class="tt">
                                                    ...
                                                    <li> <input id="professional_look" type="checkbox" price="10000" value="Professional Look"> Highly Professional Look
                                                        <span class="ques_mark"> ? </span>
                                                        <div class="Img_ho">
                                                            <div class="tt">
                                                                <img src="img/SMS-API-Blog.png">
                        ...
                        <div class="col-md-4 sticky_2">
                                        ...
                                        <div id="your_order">
                                            <div class="cart-payment-details mrl20">
                                                ...
                                                <div class="payment-details-tbl" id="looking_for" style="display:none;">
                                                    ...
                                                    <div class="value" id="package_price"><span id="website_type_status">0</span></div>
                                                </div>
                                                ...
                                                <div class="">
                                                    <div class="payment-details-tbl" id="no_of_page" style="display:none;">
                                                        <div class="name"><img src="<?php echo base_url('assets/calculate/img/check.png'); ?>"><span id="page_type">No. of
                                                                Pages </span></div>
                                                        <div class="value" id="package_price"><span id="page_type_status">0</span></div>
                                                    </div>
                                                    ...
                                                    <div class="">
                                                        <div class="payment-details-tbl" id="no_of_added_on_page" style="display:none;">
                                                    ...
                                                    <div class="payment-details-tbl" id="do_you_domain" style="display:none;">
                                                        <div class="name light-green"><img src="<?php echo base_url('assets/calculate/img/check.png'); ?>"><span id="domain_text">Domain</span></div>
                                                    ...
                                                    <div class="payment-details-tbl" id="do_you_hosting" style="display:none;">
                                                        <div class="name light-green"><img src="<?php echo base_url('assets/calculate/img/check.png'); ?>"><span id="hosting_text">Hosting</span></div>
                                                    ...
                                                    <div class="payment-details-tbl" id="do_you_emails" style="display:none;">
                                                        <div class="name light-green"><img src="<?php echo base_url('assets/calculate/img/check.png'); ?>"><span id="emailids_text">Email Ids</span></div>
                                                        <div class="value light-green">
                                                    ...
                                                    <div class="payment-details-tbl" id="professional_look_box" style="display:none;">
                            ...
                            <div class="DownLoad_c">
                                <a href="#" data-toggle="modal" data-target="#exampleModal" onclick="printData()"> Download Quotation <i class="fa fa-download" aria-hidden="true"></i></a>
                            </div>
                            ...
                            <div class="col-lg-9">
                                <div class="modal-content modal-lg">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="<?php echo base_url('web_calculate_store'); ?>" method="POST" id="myQua_form">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-group mb-3">
                                                    <input type="tel" class="form-control" id="phone1" style="width:135%" placeholder="" aria-label="company" autocomplete="off" required>
                                                    <span class="text-danger" id="output1"></span>
                                                </div>
                                                <input type="hidden" name="phone" id="hiddencontact1" required>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="city" class="form-control" id="city" placeholder="Enter Address*" name="city" autocomplete="off">
                                            </div>
                                            <div class="submit-inq">
                                                <button type="submit" form="myQua_form" class="sub-n" value="Submit" name="submit">Submit</button>
                                            </div>
                                        </form>
            ...
            <!-- <script src="<?php //echo base_url('assets/calculate/js/javascript.js'); 
                                ?>"></script> -->
                    ...
                    if (totalEmailPrice > 0) {
                        ...
                        $.ajax({
                            ...
                            data: {
                                totalprice: totalprice,
                                inc: 1,
                                totalEmailPrice: totalEmailPrice
                            },
                            success: function(response) {
                                let data = JSON.parse(response);
                                console.log(data);
