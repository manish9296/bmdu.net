    ...
    <title>Engineering Web Design Company- BMDU</title>
    <!--meta-->
    <meta name="description" content="BMDU is also the Engineering Web Design Company with experts to design web responsive designs for the engineering niche websites.">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-12">
                <h1 class="display-5 fw-bold">Engineering Web Design Company-</h1>
                <p class="lead">BMDU, is the best Engineering Web Design Company</p>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row align-items-lg-center justify-content-between">
            <div class="col-lg-6 order-lg-1 mb-7 mb-lg-0">
                <div class="mb-4">
                    <h2>Experience your product growth business</h2>
                    <p>Best eCommerce website development company work on the growth of your product by
                        constructing applications from the ground up and tie them into the media that is provided by
                        the web designer.</p>
                </div>
                <ul class="list-unstyled d-flex flex-wrap list-two-col mt-5">
                    <li>
                        ...
                        <p>Chat with our agents who are always present to help you.</p>
                    </li>
                    <li>
                        <span><i class="fal fa-headset fa-2x text-primary mb-4"></i></span>
                        <h3 class="h5">Quick Online Support</h3>
                        <p>Our team is available to guide and support you. </p>
                    </li>
                </ul>
            </div>
            <div class="col-lg-6 order-lg-2">
                <div class="pr-lg-4 position-relative">
                    <div class="bg-light text-center rounded-custom overflow-hidden p-lg-5 p-4 mx-lg-auto">
                        <img src="<?php echo base_url('assets/img/dashboard-img-4.png'); ?>" alt="Engineering Web Design Company" class="img-fluid rounded-custom shadow-sm">
        ...
        <div class="row align-items-center justify-content-lg-between">
            <div class="col-xl-5 col-lg-5">
                <div class="hero-content-wrap text-center text-xl-start text-lg-start aos-init aos-animate" data-aos="fade-right">
                    ...
                    <p class="lead">Our engineering experts bring you the best financial advice for your business that not only helps your brand grow but makes it a hit.</p>
                </div>
            </div>
                ...
                <div class="hero-img-wrap position-relative aos-init aos-animate" data-aos="fade-left">
                    ...
                    <ul class="position-absolute animate-element parallax-element shape-service hide-medium" style="transform: translate3d(0px, 0px, 0px); transform-style: preserve-3d; backface-visibility: hidden;">
                        <li class="layer" data-depth="0.03" style="position: relative; display: block; left: 0px; top: 0px; transform: translate3d(14.3175px, -7.39215px, 0px); transform-style: preserve-3d; backface-visibility: hidden;">
                            <img src="<?php echo base_url('assets/img/color-shape/image-1.svg'); ?>" alt="Engineering Web Design Company" class="img-fluid position-absolute color-shape-1">
                        </li>
                        <li class="layer" data-depth="0.02" style="position: absolute; display: block; left: 0px; top: 0px; transform: translate3d(9.54501px, -4.9281px, 0px); transform-style: preserve-3d; backface-visibility: hidden;">
                            <img src="<?php echo base_url('assets/img/color-shape/feature-2.svg'); ?>" alt="Engineering Web Design Company" class="img-fluid position-absolute color-shape-2 z-5">
                        </li>
                        <li class="layer" data-depth="0.03" style="position: absolute; display: block; left: 0px; top: 0px; transform: translate3d(14.3175px, -7.39215px, 0px); transform-style: preserve-3d; backface-visibility: hidden;">
                            <img src="<?php echo base_url('assets/img/color-shape/feature-3.svg'); ?>" alt="Engineering Web Design Company" class="img-fluid position-absolute color-shape-3">
                        </li>
                    </ul>
                    <!--animated shape end-->
                    <div class="hero-img-wrap position-relative">
                        <div class="hero-screen-wrap">
                            <div class="phone-screen">
                                <img src="<?php echo base_url('assets/img/screen/phone-screen.png'); ?>" alt="Engineering Web Design Company" class="position-relative img-fluid">
                            </div>
                            <div class="mac-screen">
                                <img src="<?php echo base_url('assets/img/screen/mac-screen.png'); ?>" alt="Engineering Web Design Company" class="position-relative img-fluid rounded-custom">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-10 col-lg-6">
                <div class="section-heading text-center aos-init aos-animate" data-aos="fade-up">
                    ...
                    <p>Being the Best manufacturing website design, we make sure to ace the process. </p>
                </div>
            </div>
        </div>
