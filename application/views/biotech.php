    ...
    <title>Hire The Best Biotech Website Design Company | BMDU</title>
    <!--meta-->
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-12">
                <h1 class="display-5 fw-bold">Biotech Website Design Company</h1>
                <p class="lead">BMDU is a Biotech Website Design Company.</p>
            </div>
        </div>
        ...
        <div class="row align-items-lg-center justify-content-between">
            <div class="col-lg-6 order-lg-1 mb-7 mb-lg-0">
                <div class="mb-4">
                    ...
                    <p>We aim to target customers, attract investors, plan viable strategic partnerships, identify
                        opportunities and build overall confidence in a product via web design for biotech company.
                        Our goal is to offer the web designing services at best prices for every industry, we are also
                        known as hospital website design company.</p>
                </div>
                <ul class="list-unstyled d-flex flex-wrap list-two-col mt-5">
                    ...
                    <li>
                        ...
                        <p>Quick only support to guide you. </p>
                    </li>
                </ul>
            </div>
            <div class="col-lg-6 order-lg-2">
                <div class="pr-lg-4 position-relative">
                    <div class="bg-light text-center rounded-custom overflow-hidden p-lg-5 p-4 mx-lg-auto">
                        <img src="<?php echo base_url('assets/img/dashboard-img-4.png'); ?>" alt="Web design for Biotech Company" class="img-fluid rounded-custom shadow-sm">
