...
<form  id="jobForm"  action="<?php echo base_url('post-update/'.$cc->job_id); ?>" method="POST" enctype="multipart/form-data" >
    <div class="row">
        <div class="col-sm-6">
            <label for="requirement" class="mb-1 text-bol">Job Title <span class="text-danger">*</span></label>
            <div class="form-group mb-3">
                <input type="text" class="form-control" id="requirement" name="requirement" placeholder=" job Title" aria-label="requirement" value="<?php echo $cc->requirement; ?>" >
        ...
        <div class="col-sm-6">
            ...
            <div class="form-group mb-3">
                <input type="text" class="form-control" id="positions" name="positions" placeholder="Job Positions" aria-label="positions" value="<?php echo $cc->positions; ?>">
        ...
        <div class="col-sm-6">
            ...
            <div class="form-group mb-3">
                <input type="text" class="form-control" id="job_type" name="job_type" placeholder="Full-Time/Part-Time/Remote" aria-label="job_type" value="<?php echo $cc->job_type; ?>" >
        ...
        <div class="col-sm-6">
            ...
            <div class="form-group mb-3">
                <input type="text" class="form-control" id="experience" name="experience" placeholder="Fresher/Experience" aria-label="experience" value="<?php echo $cc->experience; ?>" >
                <p id="experienceError" class="text-danger"></p>
                  ...
                  <div class="col-sm-6">
                     ...
                     <div class="form-group mb-3">
                        <input type="text" class="form-control"   id="opening" name="opening" placeholder="Number of Opening" aria-label="opening" autocomplete="off" value="<?php echo $cc->opening; ?>"  />
                  ...
                  <div class="col-sm-6">
                     ...
                     <div class="form-group mb-3">
                        <input type="salary" class="form-control"   name="salary" id="salary"  placeholder="Salary" aria-label="salary" autocomplete="off" value="<?php echo $cc->salary; ?>" >
                  ...
                  <div class="col-sm-12">
                     ...
                     <div class="form-group mb-3">
                        <textarea name="job_desc" id="job_desc" cols="100" rows="200"><?php echo $cc->job_desc; ?></textarea>
                        <p id="job_descError" class="text-danger"></p>
                     </div>
                  </div>
               <button type="submit"  name="submit" class="btn btn-primary mt-4">Get in Update Job</button>
            </form>
         </div>
              </div>
          </div>
