...
if (empty($var['id'])) {
    echo "<script>window.location.href='http://localhost/manish/hr'</script>";
}
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    <nav class="navbar navbar-expand-sm bg-info">
        <a href = "<?php echo base_url('hr_dash') ?>" class = "navbar-brand fs-4 ms-3  text-light">BMDU Logo</a>
        ...
        <a href ="<?php echo base_url('hrLogout') ?>" class = "navbar-brand fs-4 me-5  text-light">Logout</a>
    </nav>
