...
<form  id="blogForm"  action="<?php echo base_url('blog-update-code/'.$post->id ); ?>" method="POST" enctype="multipart/form-data" >
    <div class="row">
        <div class="col-sm-6">
        ...
        <div class="col-sm-6">
            ...
            <div class="form-group mb-3">
                <input type="text" class="form-control" id="meta_keywords_show" name="meta_keywords" placeholder="Meta Keywords" aria-label="meta_keywords" value="<?php echo $post->meta_keywords; ?>">
    ...
    <div class="form-group mb-3">
        <select class="form-control" id="blog_tags" name="category_id" aria-label="blog_tags">
            <option value="" disabled>Select Blog Category Tags</option>
                <option value="<?= $post->cat_id; ?>" <?php if($post->category_id == $post->category_id) echo 'selected'; ?>>
                    <?= $post->category_name; ?>
                </option>
        </select>
        <p id="blog_tagsError" class="text-danger"><?php echo isset($validation_errors['category_id']) ? $validation_errors['category_id'] : ''; ?></p>
    </div>
</div> -->
<div class="col-sm-6">
    <label for="blog_tags" class="mb-1 text-bold">Blog Category Tags <span class="text-danger">*</span></label>
    <div class="form-group mb-3">
        <select class="form-control" id="blog_tags" name="category_id" aria-label="blog_tags">
            ...
            <?php foreach($blog_categories as $category): ?>
                <option value="<?= $category->cat_id; ?>" <?php if($category->cat_id == $post->category_id) echo 'selected'; ?>>
                    <?= $post->category_name; ?>
                </option>
            <?php endforeach; ?>
        </select>
...
$(document).ready(function() {
    $('#blogForm').submit(function(e) {
        ...
        var metaKeywords = $('#meta_keywords_show').val();
