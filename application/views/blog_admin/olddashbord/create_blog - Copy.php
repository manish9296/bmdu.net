...
<form  id="blogForm"  action="<?php echo base_url('blog_create_code'); ?>" method="POST" enctype="multipart/form-data" >
    <div class="row">
        ...
        <div class="col-sm-6">
            ...
            <div class="form-group mb-3">
                <input type="text" class="form-control" id="meta_keywords" name="meta_keywords" placeholder="Meta Keywords" aria-label="meta_keywords" >
        ...
        <!-- <div class="col-sm-6">
            ...
            <div class="form-group mb-3">
                <input type="text" class="form-control" id="blog_titile" name="blog_title" placeholder="blog Tags" aria-label="blog_titile" >
