...
<a href="<?php echo base_url('create-blog-category') ?>" class="btn_1">Create New Category</a>
</div>
...
<form  id="blogForm"  action="<?php echo base_url('blog_create_code'); ?>" method="POST" enctype="multipart/form-data" >
    <div class="row">
        ...
        <div class="col-sm-6">
            ...
            <div class="form-group mb-3">
                <input type="" class="form-control" id="meta_keywords_show" name="meta_keywords" placeholder="Meta Keywords" aria-label="meta_keywords" >
...
$(document).ready(function() {
    $('#blogForm').submit(function(e) {
        ...
        var blogCategory = $('#blog_tags').val();
        if (blogCategory === null || blogCategory === '') {
            $('#blog_tagsError').text('Blog Category is required');
            e.preventDefault();
        }
