    ...
    <title>Grow Your Online Presence With Best Digital Marketing Team</title>
    <!--meta-->
    <meta name="description" content="BMDU have the best digital marketing team helping businesses to grow their online presence organically via SEO, SMM, Content Marketing.">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-12">
                <h1 class="display-5 fw-bold">Digital Marketing Team</h1>
                <p class="lead">Digital marketing agency in delhi bringing you the best digital marketing team includes experts.</p>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row align-items-lg-center justify-content-between">
            <div class="col-lg-6 order-lg-2 mb-7 mb-lg-0">
                <div class="mb-4">
                    <h2>EXPERIENCE YOUR BUSINESS GROW</h2>
                    <p>Experience the gradual growth of your business with the best digital marketing company in delhi and hard work of our team to make it a success </p>
                </div>
                <ul class="list-unstyled d-flex flex-wrap list-two-col mt-5">
                    <li>
                        ...
                        <p>Our objective is to offer what our customers need</p>
                    </li>
                    <li>
                        <span><i class="fal fa-watch fa-2x text-primary mb-4"></i></span>
                        <h3 class="h5">Real time metrics</h3>
                        <p>Making sure to master every little is our duty. </p>
                    </li>
                </ul>
            </div>
        ...
        <div class="row align-items-center justify-content-lg-between">
            <div class="col-xl-5 col-lg-5">
                <div class="hero-content-wrap text-center text-xl-start text-lg-start aos-init aos-animate" data-aos="fade-right">
                    <h1 class="fw-bold display-5">Powerful Solutions for Your powerful Business</h1>
                    <p class="lead">Our digital marketing team aims to find ultimate solutions for your ultimate business.</p>
                </div>
            </div>
        ...
        <div class="row align-items-lg-center justify-content-between">
            <div class="col-lg-6 order-lg-1 mb-7 mb-lg-0">
                <div class="mb-4">
                    ...
                    <p>Our digital marketers know every little way to market your brand that helps in reach, growth and success. </p>
                </div>
                <ul class="list-unstyled d-flex flex-wrap list-two-col mt-5">
                    <li>
                        <span><i class="fal fa-comments-alt fa-2x text-primary mb-4"></i></span>
                        <h3 class="h5">Live Chat with Agent</h3>
                        <p>Live chat with an agent to clear your doubts anytime.</p>
                    </li>
                    <li>
                        <span><i class="fal fa-headset fa-2x text-primary mb-4"></i></span>
                        <h3 class="h5">Quick Online Support</h3>
                        <p>To make the process of understanding simpler. </p>
                    </li>
                </ul>
            </div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-10 col-lg-6">
                <div class="section-heading text-center">
                    ...
                    <p>As much as your investments matter, our results matter too. BMDU Brings you the digital marketing company that aims to provide customers with the best possible results. Hire UI Designers, Digital Marketing Team, Web designers to stand out in crowd.</p>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-md-6 col-lg-4 mt-4 mt-lg-0 mt-md-0">
                <div class="bg-gradient p-5 text-center d-flex flex-column h-100 rounded-custom">
                    <div class="promo-card-info mb-4">
                        ...
                        <p>Our developers make sure and put their best foot forward and have handled upto 5k successful projects. </p>
                    </div>
